  ...
  return (
    <div className="m-4 p-5 box-shadow border-1 h-100">
      ...
      <div className="flex justify-center m-4">
        <div className="preview flex space-even w-100">
          <div className="border-1 p-4 w-3 h-5 box-shadow">
            This is a vertical card (small).
          </div>

          <div className="border-1 p-4 w-4 h-6 box-shadow">
      ...
      <div className="flex justify-center m-4">
        <div className="preview flex space-even w-100">
          <div className="border-1 p-4 w-5 h-3 box-shadow">
            This is a horizontal card (small).
          </div>
          <div className="border-1 p-4 w-6 h-4 box-shadow">
      ...
      <div className="flex justify-center m-4">
        <div className="preview flex space-even w-100">
          <div className="border-1 p-4 w-3 h-5 box-shadow pos-rel">
            This is a vertical card (small).
            <div className="pos-abs top-right m-2">
              <i className="fas fa-heart color-3"></i>
            </div>
          </div>
          <div className="border-1 p-4 w-5 h-3 box-shadow pos-rel">
            This is a horizontal card (small).
            <div className="pos-abs top-right m-2">
